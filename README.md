...
---
<center><img src="https://raw.githubusercontent.com/savagetech56/darknetudp/main/bin/banner.jpg" alt="banner" width="400"/></center>
...
``` 
```
git clone https://github.com/savagetech56/darknetudp && cd darknetudp && chmod +x install.sh && ./install.sh
```
